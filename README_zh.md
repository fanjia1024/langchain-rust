...
- [官方文档](https://langchain-rust.sellie.tech/get-started/quickstart)
- [示例目录](examples/)
- [API 文档](https://docs.rs/langchain-rust)
...
- [Crates.io](https://crates.io/crates/langchain-rust)
- [文档](https://langchain-rust.sellie.tech)
- [Discord](https://discord.gg/JJFcTFbanu)
- [GitHub 仓库](https://github.com/Abraxas-365/langchain-rust)
