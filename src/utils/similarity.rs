...
/// # 示例
/// ```rust
/// use langchain_rs::utils::cosine_similarity_f64;
///
...
/// # 示例
/// ```rust
/// use langchain_rs::utils::cosine_similarity_f32;
///
...
/// # 示例
/// ```rust
/// use langchain_rs::utils::batch_cosine_similarity_f64;
///
...
/// # 示例
/// ```rust
/// use langchain_rs::utils::text_similarity;
///
