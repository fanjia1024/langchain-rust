...
/// # 示例
/// ```rust
/// use langchain_rust::utils::cosine_similarity_f64;
///
...
/// # 示例
/// ```rust
/// use langchain_rust::utils::cosine_similarity_f32;
///
...
/// # 示例
/// ```rust
/// use langchain_rust::utils::batch_cosine_similarity_f64;
///
...
/// # 示例
/// ```rust
/// use langchain_rust::utils::text_similarity;
///
