...
async fn main() {
    ...
    use langchain_ai_rust::vectorstore::VecStoreOptions;
    ...
    let store = StoreBuilder::new()
        .embedder(embedder)
        .client(client)
        .collection_name("langchain-ai-rust")
        .build()
        .await
        .unwrap();
    ...
    let doc1 = Document::new(
        "langchain-ai-rust is a port of the langchain python library to rust and was written in 2024.",
    );
