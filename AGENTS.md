...
- Types and helpers in `langchain_rust::agent::deep_agent::skills`: `SkillMeta`, `load_skill_index`, `match_skills`, `load_skill_full_content`. Middleware: `SkillsMiddleware`, `build_skills_middleware`. Example: `deep_agent_skills`.
